...
<div class="relative min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8  bg-no-repeat bg-cover relative items-center">
  <div class="w-full sm:w-6/12 lg:w-4/12 xl:w-4/12  overflow-y-scroll space-y-3 border-8 rounded-3xl bg-white border-gray-800 shadow-2xl z-10">
    <div class="realtive sticky top-0  h-36 w-full rounded-b-3xl bg-center cursor-pointer object-cover z-10 shadow-lg"
      style="background-image:url('https://cdn.pixabay.com/photo/2017/07/03/20/17/colorful-2468874__480.jpg&amp;ixlib=rb-1.2.1&amp;auto=format&amp;fit=crop&amp;w=1950&amp;q=80')">
          ...
          <div class="flex justify-end items-center relative">
            <div class="inline relative">
              <div class="block flex-grow-0 flex-shrink-0">
                <svg 
                  xmlns="http://www.w3.org/2000/svg" 
                  class="bg-white h-5 w-5 rounded-full" 
                  viewBox="0 0 20 20" 
                  fill="currentColor">
                  <path 
                    fill-rule="evenodd"
  ...
  <div class="px-3 rounded-lg  flex flex-col w-full">
    <h4 class="text-white text-xl font-semibold  leading-tight truncate">Go Rival Go</h4>
    <div class="flex justify-between items-center ">
      <div class="flex flex-col rounded-sm p-2">
        <h2 class="text-sm flex items-center text-black text-md font-normal">
...
<div class=" p-3 space-y-4 z-0">
  <h4 class="font-semibold mt-2">Dashboard</h4>
